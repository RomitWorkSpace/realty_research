...
const CommercialCategoryFilter = () => {
  ...
  const {cityname, queryLocation, queryCategory} = useParams();
  ...
  const breadcrumbData = [{name : "Commercial Property", link : `https://realtyresearch.in/property/${cityname}/all/commercial`}]
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        axios.get(`https://thefilmcitynoida.com/api/property-category/${cityname}/${queryLocation}/${queryCategory}`).then(res => {
  ...
  return (
    <>
    <OnPage MetaTitle="Commercial Properties in Noida – Offices & Shops for Sale"
    Keywords="commercial property Noida, shops for sale Noida, office space Noida, business property Noida, Realty Research Noida"
    MetaDesc="Discover top commercial spaces in Noida including offices, retail shops, and business hubs. Realty Research offers verified listings and expert advice."
    />
    <DynamicBreadcrumb BreadcrumbData={breadcrumbData} CurrentPage={cityname} />
      ...
      <div className="">
        ...
        <div className="relative mb-4">
          ...
          >
            ...
            <FilterSection title="Washrooms" flex="yes" category="washrooms" options={filterOptions.washrooms} />
...
export default CommercialCategoryFilter;